...
public class FirstClass {
	...
	public static void main(String[] args) {
		System.out.println("first commit from local master branc");
		...
		System.out.println("forth commit from remote master branch");

		System.out.println("Here is a merge conflict T create from local master");
